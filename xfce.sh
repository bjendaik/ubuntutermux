...
dbus-launch startxfce4" > /usr/local/bin/vncstart
   ...
   clear
   echo ""
   echo "Cài đặt trình duyệt,.."
   echo ""
#Browser Fix
cp /etc/apt/sources.list ~/
wget https://raw.githubusercontent.com/bjendaik/ubuntutermux/main/passwd -P .vnc/
...
wget -O $(find ~/.mozilla/firefox -name *.default-esr)/user.js https://raw.githubusercontent.com/bjendaik/ubuntutermux/main/user.js
